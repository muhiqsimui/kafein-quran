...
export default function ZakatPage() {
  ...
  const [goldPrice, setGoldPrice] = useState<number>(3200000);
  ...
  const fitrahCommodities = [
    ...
    {
      id: "susu",
      name: "Keju / Susu Kering",
      weight: 2.5,
      label: "Susu Kering (2.5 kg)",
    },
  ];
    ...
    switch (activeType) {
      ...
      case "maal": {
        ...
        return {
          ...
          reachedNisab,
          zakatAmount,
          nisab: nisabGoldYearly,
          label: "Total Harta",
        };
      }
      case "fitrah": {
        const selectedCommodity =
          fitrahCommodities.find((c) => c.id === fitrahType) ||
          fitrahCommodities[0];
      ...
      case "emas": {
        ...
        return {
          goldZakat,
          silverZakat,
          zakatAmount: goldZakat + silverZakat,
          reachedNisab: goldWeight >= 85 || silverWeight >= 595,
          nisab: 0,
        };
      }
      case "pertanian": {
        const rate =
          irrigationType === "rain"
            ...
            : irrigationType === "mixed"
              ...
              : 0.05;
        const selectedAgri =
          agricultureCommodities.find((a) => a.id === agricultureType) ||
          agricultureCommodities[0];
              ...
              {[
                {
                  ...
                  desc: "Zakat hanya diwajibkan bagi setiap Muslim.",
                },
                {
                  title: "Merdeka",
                  desc: "Bukan merupakan budak atau hamba sahaya.",
                },
                {
                  title: "Milik Sempurna",
                  desc: "Harta dimiliki sepenuhnya dan ada dalam kendali pemilik.",
                },
                {
                  title: "Mencapai Nisab",
                  desc: "Harta mencapai batas minimum kewajiban zakat.",
                },
                {
                  title: "Mencapai Haul",
                  desc: "Harta telah dimiliki selama satu tahun Hijriah (kecuali hasil bumi/pertanian).",
                },
                {
                  title: "Lebihan Keperluan Asasi",
                  desc: "Harta setelah dikurangi kebutuhan pokok pemenuhan hidup.",
                },
                {
                  title: "Bebas dari Hutang",
                  desc: "Pemilik tidak memiliki hutang yang harus dilunasi segera.",
                },
              ].map((item, i) => (
      ...
      <div className="bg-card p-6 rounded-3xl border border-border space-y-4 shadow-sm">
        ...
        <div className="rounded-xl border border-primary/20 bg-primary/5 p-3">
          <p className="flex items-start gap-2 text-xs leading-relaxed text-foreground/80">
            ...
            <span>
              Sesuaikan harga emas dengan harga emas murni (24 karat) hari ini
              di daerah Anda untuk perhitungan nisab yang lebih tepat. Untuk
              harga beras sesuaikan dengan harga beras yang biasa Anda konsumsi
              sehari-hari.
            </span>
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {activeType === "penghasilan" && (
              <>
                <p className="text-xs leading-relaxed text-muted-foreground">
                  Note: Sebagian ulama berpendapat penghasilan yg kena zakat
                  apabila penghasilan tersebut telah mengendap selama satu tahun
                </p>
                <p className="text-xs leading-relaxed text-muted-foreground">
                  “Tidak ada zakat pada harta hingga berlalu satu tahun.” (HR.
                  Abu Dawud)
                </p>
                <div className="space-y-2">
                  <label className="text-sm font-medium">
                    Pendapatan Bulanan (Gaji, dsb)
                  </label>
                  <div className="relative">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setOtherIncome(parseDots(e.target.value))
                      }
                      className="w-full pl-10 p-3 rounded-xl bg-accent/50 border border-border outline-none focus:ring-2 focus:ring-primary/20"
                      placeholder="0"
                    />
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setInvestments(parseDots(e.target.value))
                      }
                      className="w-full pl-10 p-3 rounded-xl bg-accent/50 border border-border outline-none focus:ring-2 focus:ring-primary/20"
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCurrentAssets(parseDots(e.target.value))
                      }
                      className="w-full pl-10 p-3 rounded-xl bg-accent/50 border border-border outline-none focus:ring-2 focus:ring-primary/20"
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setReceivables(parseDots(e.target.value))
                      }
                      className="w-full pl-10 p-3 rounded-xl bg-accent/50 border border-border outline-none focus:ring-2 focus:ring-primary/20"
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setShortTermDebt(parseDots(e.target.value))
                      }
                      className="w-full pl-10 p-3 rounded-xl bg-accent/50 border border-border outline-none focus:ring-2 focus:ring-primary/20"
                    />
                  </div>
              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[10px] text-muted-foreground italic">
                    *Nisab{" "}
                    {
                      agricultureCommodities.find(
                        (a) => a.id === agricultureType,
                      )?.name
                    }{" "}
                    adalah{" "}
                    {
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    ...
                    >
                      <div className="flex justify-between items-center w-full">
                        <span
                          className={cn(
                            "font-bold",
                            irrigationType === "rain" ? "text-primary" : "",
                          )}
                        >
                          Alami (10%)
                        </span>
                      ...
                      <span className="text-[10px] text-muted-foreground">
                        Menggunakan air hujan, sungai, atau mata air tanpa biaya
                        tambahan.
                      </span>
                    </button>
                    ...
                    >
                      ...
                      <span className="text-[10px] text-muted-foreground">
                        Menggunakan alat bantu (pompa, air beli, dsb) yang
                        mengeluarkan biaya.
                      </span>
                    </button>
                    ...
                    >
                      <div className="flex justify-between items-center w-full">
                        <span
                          className={cn(
                            "font-bold",
                            irrigationType === "mixed" ? "text-primary" : "",
                          )}
                        >
                          Campuran (7.5%)
                        </span>
                      ...
                      <span className="text-[10px] text-muted-foreground">
                        Perpaduan antara pengairan alami dan bantuan yang
                        mengeluarkan biaya.
                      </span>
                    </button>
                  </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          >
              ...
              {results.nisab > 0 && (
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="font-medium text-xs">
                    {activeType === "pertanian"
                      ? `${results.nisab} kg`
                      : formatCurrency(results.nisab || 0).replace(",00", "")}
                  </span>
                </div>
              )}
            </div>
            ...
            {!results.reachedNisab && (
              <p className="text-[10px] text-muted-foreground italic mt-2 leading-relaxed">
                *Harta belum mencapai nisab. Anda tetap disarankan untuk
                berinfaq agar harta lebih berkah.
              </p>
            )}
          </div>
          {/* Catatan Fiqh */}
          <div className="p-4 rounded-xl border bg-muted/50 space-y-2">
            ...
            {activeType === "penghasilan" && (
              <p className="text-xs leading-relaxed text-muted-foreground">
                Zakat penghasilan dihitung dari pendapatan bersih bulanan. Nisab
                setara nilai 85 gram emas per tahun (dibagi 12). Kadar zakat
            ...
            {activeType === "maal" && (
              <p className="text-xs leading-relaxed text-muted-foreground">
                ...
                <span className="font-medium text-foreground">
                  tabungan, deposito, atau surat berharga
                </span>{" "}
                yang mengendap
                <span className="font-medium text-foreground">
                  {" "}
            ...
            {activeType === "fitrah" && (
              <p className="text-xs leading-relaxed text-muted-foreground">
                Zakat fitrah wajib bagi setiap jiwa Muslim dan ditunaikan
                sebelum shalat Idul Fitri. Standarnya
                <span className="font-medium text-foreground">
                  {" "}
            ...
            {activeType === "perdagangan" && (
              <p className="text-xs leading-relaxed text-muted-foreground">
                Zakat perdagangan dihitung dari (Modal + Barang + Piutang)
                dikurangi hutang jatuh tempo. Nisab setara
                <span className="font-medium text-foreground">
                  {" "}
                  85 gram emas
                </span>
            ...
            {activeType === "pertanian" && (
              <p className="text-xs leading-relaxed text-muted-foreground">
                Zakat pertanian dikeluarkan setiap panen apabila hasil mencapai
                nisab
                <span className="font-medium text-foreground">
                  {" "}
                  653 kg gabah/makanan pokok
                </span>
                . Kadar zakat:{" "}
                ...
                (berbiaya), atau
                <span className="font-medium text-foreground"> 7,5%</span>{" "}
                (campuran).
              </p>
            )}
          </div>
